...
class ChooseRebornScreen(Screens):
    ...
    def screen_switches(self):
        ...
        self.alive_tab = UIImageButton(ui_scale(pygame.Rect((200, 653), (150, 70))), "",
                                              object_id="#alive_select_button", manager=MANAGER)
        self.dead_tab = UIImageButton(ui_scale(pygame.Rect((360, 653), (150, 70))), "",
