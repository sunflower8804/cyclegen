...
class TalkScreen(Screens):
    ...
    def add_to_cat_dict(self, abbrev, cluster, x, rel, r, abbrev_cat, text):
        """ Adds a cat to the dict, assigning them to their abbrev to be reused in later text. """

        if cluster and rel:
            self.cat_dict[f"{r}_{abbrev}_{x}"] = abbrev_cat
            text = re.sub(fr'(?<!\/){r}_{abbrev}_{x}(?!\/)', str(abbrev_cat.name), text)
        elif cluster and not rel:
            self.cat_dict[f"{abbrev}_{x}"] = abbrev_cat
            text = re.sub(fr'(?<!\/){abbrev}_{x}(?!\/)', str(abbrev_cat.name), text)
        elif rel and not cluster:
            self.cat_dict[f"{r}_{abbrev}"] = abbrev_cat
            text = re.sub(fr'(?<!\/){r}_{abbrev}(?!\/)', str(abbrev_cat.name), text)
        else:
            self.cat_dict[f"{abbrev}"] = abbrev_cat
            text = re.sub(fr'(?<!\/){abbrev}(?!\/)', str(abbrev_cat.name), text)
        
        return text

    def cat_dict_check(self, abbrev, cluster, x, rel, r, text):
        """ Checks if a cat is in the dict already.
        If so, it will reuse the name in later text.
        If not, it will find a cat for the abbrev."""

        in_dict = False
        if f"{abbrev}_{x}" in self.cat_dict or f"{abbrev}" in self.cat_dict or f"{r}_{abbrev}" in self.cat_dict or f"{r}_{abbrev}_{x}" in self.cat_dict:
            in_dict = True
            if cluster and rel:
                text = re.sub(fr'(?<!\/){r}_{abbrev}_{x}(?!\/)', str(self.cat_dict[f"{r}_{abbrev}_{x}"].name), text)
            elif cluster and not rel:
                text = re.sub(fr'(?<!\/){abbrev}_{x}(?!\/)', str(self.cat_dict[f"{abbrev}_{x}"].name), text)
            elif rel and not cluster:
                text = re.sub(fr'(?<!\/){r}_{abbrev}(?!\/)', str(self.cat_dict[f"{r}_{abbrev}"].name), text)
            else:
                text = re.sub(fr'(?<!\/){abbrev}(?!\/)', str(self.cat_dict[f"{abbrev}"].name), text)
        return text, in_dict


    def abbrev_addons(self, t_c, r_c, cluster, x, rel, r):
        ...
        try:
            if "your_crush" in text:
                ...
                if match2:
                    ...
                    r = ""
                text, in_dict = self.cat_dict_check("your_crush", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    for c in self.get_living_cats():
                        addon_check = self.abbrev_addons(cat, c, cluster, x, rel, r)
                        ...
                        if relations.romantic_love > 10:
                            ...
                            break
                    if crush:
                        text = self.add_to_cat_dict("your_crush", cluster, x, rel, r, crush, text)
                    else:
                        return ""
            ...
            if "their_crush" in text:
                ...
                text, in_dict = self.cat_dict_check("their_crush", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    for c in self.get_living_cats():
                        ...
                        if relations.romantic_love > 10:
                            ...
                            break
                    if crush:
                        text = self.add_to_cat_dict("their_crush", cluster, x, rel, r, crush, text)
                    else:
                        return ""
            ...
            for i in range(0,4):
                ...
                if r_c_str in text:
                    ...
                    text, in_dict = self.cat_dict_check(r_c_str, cluster, x, rel, r, text)
                    ...
                    if in_dict is False:
                        ...
                        addon_check = self.abbrev_addons(cat, alive_cat, cluster, x, rel, r)
                        counter = 0

                        while (alive_cat.ID == you.ID or alive_cat.ID == cat.ID or addon_check is False\
                        or alive_cat in list(self.cat_dict.values())):
                            alive_cat = choice(alive_cats)
                            addon_check = self.abbrev_addons(cat, alive_cat, cluster, x, rel, r)
                            counter += 1
                            if counter >= 30:
                                return ""
                        text = self.add_to_cat_dict(f"r_c{i}", cluster, x, rel, r, alive_cat, text)
                ...
                if r_w_str in text:
                    ...
                    text, in_dict = self.cat_dict_check(f"r_w{i}", cluster, x, rel, r, text)
                    ...
                    or alive_cat in list(self.cat_dict.values())):
                        ...
                        if counter > COUNTER_LIM:
                            return ""
                    text = self.add_to_cat_dict(f"r_w{i}", cluster, x, rel, r, alive_cat, text)
            ...
            if "n_r1" in text:
                ...
                addon_check1 = self.abbrev_addons(cat, random_cat1, cluster1, x, rel1, r)
                addon_check2 = self.abbrev_addons(cat, random_cat2, cluster2, x, rel2, r)
                counter = 0
                ...
                text = self.add_to_cat_dict("n_r1", cluster1, x, rel1, r, random_cat1, text)
                text = self.add_to_cat_dict("n_r2", cluster2, x, rel2, r, random_cat2, text)
            ...
            if "r_k" in text:
                ...
                text, in_dict = self.cat_dict_check("r_k", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    addon_check = self.abbrev_addons(cat, alive_kit, cluster, x, rel, r)
                    ...
                    text = self.add_to_cat_dict("r_k", cluster, x, rel, r, alive_kit, text)
            ...
            if "r_a" in text:
                ...
                text, in_dict = self.cat_dict_check("r_a", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    addon_check = self.abbrev_addons(cat, alive_app, cluster, x, rel, r)
                    counter = 0
                    ...
                    text = self.add_to_cat_dict("r_a", cluster, x, rel, r, alive_app, text)
            ...
            if "r_w" in text and "r_w1" not in text and "r_w2" not in text and "r_w3" not in text:
                ...
                text, in_dict = self.cat_dict_check("r_w", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("r_w", cluster, x, rel, r, alive_app, text)
            ...
            if "r_m" in text:
                ...
                text, in_dict = self.cat_dict_check("r_m", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("r_m", cluster, x, rel, r, alive_app, text)
            ...
            if "r_d" in text:
                ...
                text, in_dict = self.cat_dict_check("r_d", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("r_d", cluster, x, rel, r, alive_app, text)
            ...
            if "r_q" in text:
                ...
                text, in_dict = self.cat_dict_check("r_q", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("r_q", cluster, x, rel, r, alive_app, text)
            ...
            if "r_e" in text:
                ...
                text, in_dict = self.cat_dict_check("r_e", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("r_e", cluster, x, rel, r, alive_app, text)
            ...
            if "r_s" in text:
                ...
                text, in_dict = self.cat_dict_check("r_s", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    while (alive_app.ID == you.ID or alive_app.ID == cat.ID or addon_check is False or not alive_app.is_ill()):
                        ...
                        if counter == 30:
                            return ""
                    text = self.add_to_cat_dict("r_s", cluster, x, rel, r, alive_app, text)
            ...
            if "r_i" in text:
                ...
                text, in_dict = self.cat_dict_check("r_i", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    while alive_app.ID == you.ID or alive_app.ID == cat.ID or addon_check is False or not alive_app.is_injured():
                        ...
                        if counter == 30:
                            return ""
                    text = self.add_to_cat_dict("r_i", cluster, x, rel, r, alive_app, text)
            # random grieving cat
            if "r_g" in text:
                cluster = False
                rel = False
                ...
                text, in_dict = self.cat_dict_check("r_g", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    while (alive_app.ID == you.ID or alive_app.ID == cat.ID or addon_check is False or "grief stricken" not in alive_app.illnesses):
                        ...
                        if counter == 40:
                            return ""
                    text = self.add_to_cat_dict("r_g", cluster, x, rel, r, alive_app, text)
            ...
            if "y_s" in text:
                ...
                text, in_dict = self.cat_dict_check("y_s", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    addon_check = self.abbrev_addons(cat, sibling, cluster, x, rel, r)
                    ...
                    text = self.add_to_cat_dict("y_s", cluster, x, rel, r, sibling, text)
            ...
            if "y_l" in text:
                ...
                text, in_dict = self.cat_dict_check("y_l", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("y_l", cluster, x, rel, r, sibling, text)
            ...
            if "t_s" in text:
                ...
                text, in_dict = self.cat_dict_check("t_s", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("t_s", cluster, x, rel, r, sibling, text)
            ...
            if "t_l" in text:
                ...
                text, in_dict = self.cat_dict_check("t_l", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("t_l", cluster, x, rel, r, alive_app, text)
            ...
            if "y_p" in text:
                ...
                text, in_dict = self.cat_dict_check("y_p", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    try:
                        ...
                        return ""
                    addon_check = self.abbrev_addons(cat, parent, cluster, x, rel, r)

                    if len(you.inheritance.get_parents()) == 0 or parent.outside or parent.dead or parent.ID == cat.ID or\
                    addon_check is False:
                        return ""
                    
                    text = self.add_to_cat_dict("y_p", cluster, x, rel, r, parent, text)
            ...
            if "y_m" in text:
                ...
                if match2:
                    ...
                    r = ""
                text, in_dict = self.cat_dict_check("y_m", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    if you.mate:
                        ...
                        return ""
                    addon_check = self.abbrev_addons(cat, mate0, cluster, x, rel, r)
                    ...
                    text = self.add_to_cat_dict("y_m", cluster, x, rel, r, mate0, text)
            ...
            if "t_m" in text:
                ...
                if match2:
                    ...
                    r = ""
                text, in_dict = self.cat_dict_check("t_m", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    if cat.mate:
                        ...
                        return ""
                    addon_check = self.abbrev_addons(cat, mate1, cluster, x, rel, r)
                    ...
                    text = self.add_to_cat_dict("t_m", cluster, x, rel, r, mate1, text)
            ...
            if "t_ka" in text:
                ...
                if match2:
                    ...
                    r = ""
                text, in_dict = self.cat_dict_check("t_ka", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    addon_check = self.abbrev_addons(cat, kit, cluster, x, rel, r)

                    if kit.moons < 12 or kit.outside or kit.dead or kit.ID == cat.ID or kit.ID == you.ID or\
                    addon_check is False:
                        return ""
                    
                    text = self.add_to_cat_dict("t_ka", cluster, x, rel, r, kit, text)
            ...
            if "t_kk" in text:
                ...
                if match2:
                    ...
                    r = ""
                text, in_dict = self.cat_dict_check("t_kk", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("t_kk", cluster, x, rel, r, kit, text)
            ...
            if "t_k" in text and "t_kk" not in text and "t_ka" not in text:
                ...
                if match2:
                    ...
                    r = ""
                text, in_dict = self.cat_dict_check("t_k", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("t_k", cluster, x, rel, r, kit, text)
            ...
            if "y_k" in text and "y_kk" not in text:
                ...
                if match2:
                    ...
                    r = ""
                text, in_dict = self.cat_dict_check("y_k", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("r_w", cluster, x, rel, r, kit, text)
            ...
            if "y_kk" in text:
                ...
                if match2:
                    ...
                    r = ""
                text, in_dict = self.cat_dict_check("y_kk", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("y_kk", cluster, x, rel, r, kit, text)
            ...
            if "r_c" in text and "r_c1" not in text and "r_c2" not in text and "r_c3" not in text and "r_c4" not in text:
                ...
                text, in_dict = self.cat_dict_check("r_c", cluster, x, rel, r, text)

                if in_dict is False:
                    random_cat = choice(self.get_living_cats())
                    addon_check = self.abbrev_addons(cat, random_cat, cluster, x, rel, r)
                    ...
                    text = self.add_to_cat_dict("r_c", cluster, x, rel, r, random_cat, text)
            # Other Clan
            if "o_c" in text:
            ...
            if "l_n" in text:
                ...
                if game.clan.leader is None:
                    return ""
                addon_check = self.abbrev_addons(cat, game.clan.leader, cluster, x, rel, r)
                ...
                text = self.add_to_cat_dict("l_n", cluster, x, rel, r, game.clan.leader, text)
            ...
            if "d_n" in text:
                ...
                if game.clan.deputy is None:
                    return ""
                addon_check = self.abbrev_addons(cat, game.clan.deputy, cluster, x, rel, r)
                ...
                text = self.add_to_cat_dict("d_n", cluster, x, rel, r, game.clan.deputy, text)
            ...
            if "d_c" in text:
                ...
                text, in_dict = self.cat_dict_check("d_c", cluster, x, rel, r, text)

                if in_dict is False:
                    dead_cat = Cat.all_cats.get(choice(game.clan.starclan_cats))
                    addon_check = self.abbrev_addons(cat, dead_cat, cluster, x, rel, r)
                    ...
                    text = self.add_to_cat_dict("d_c", cluster, x, rel, r, dead_cat, text)
            ...
            if "rdf_c" in text:
                ...
                text, in_dict = self.cat_dict_check("rdf_c", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("rdf_c", cluster, x, rel, r, random_cat, text)
            ...
            if "rsh_c" in text:
                ...
                text, in_dict = self.cat_dict_check("rsh_c", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("rsdh_c", cluster, x, rel, r, random_cat, text)
            ...
            if "rsh_k" in text:
                ...
                text, in_dict = self.cat_dict_check("rsh_k", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("rsh_k", cluster, x, rel, r, alive_kit, text)
            ...
            if "rsh_a" in text:
                ...
                text, in_dict = self.cat_dict_check("rsh_a", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("rsh_a", cluster, x, rel, r, alive_app, text)
            ...
            if "rsh_w" in text:
                ...
                text, in_dict = self.cat_dict_check("rsh_w", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("rsh_w", cluster, x, rel, r, alive_app, text)
            ...
            if "rsh_m" in text:
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("rsh_m", cluster, x, rel, r, alive_app, text)
            ...
            if "rsh_d" in text:
                ...
                text, in_dict = self.cat_dict_check("rsh_d", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("rsh_d", cluster, x, rel, r, alive_app, text)
            ...
            if "rsh_q" in text:
                ...
                text, in_dict = self.cat_dict_check("rsh_q", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("rsh_q", cluster, x, rel, r, alive_app, text)
            ...
            if "rsh_e" in text:
                ...
                text, in_dict = self.cat_dict_check("rsh_e", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("rsh_e", cluster, x, rel, r, alive_app, text)
            ...
            if "sh_d" in text:
                ...
                text = self.add_to_cat_dict("sh_d", cluster, x, rel, r, random_cat, text)
            ...
            if "sh_l" in text:
                ...
                text = self.add_to_cat_dict("sh_l", cluster, x, rel, r, random_cat, text)
            ...
            if "l_c" in text:
                ...
                if match2:
                    ...
                    r = ""
                text, in_dict = self.cat_dict_check("l_c", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("l_c", cluster, x, rel, r, alive_app, text)
            ...
            if "e_c" in text:
                ...
                text, in_dict = self.cat_dict_check("e_c", cluster, x, rel, r, text)
                ...
                if in_dict is False:
                    ...
                    text = self.add_to_cat_dict("e_c", cluster, x, rel, r, alive_app, text)
            ...
            if game.clan.focus_cat is not None:
                if "fc_c" in text:
                    ...
                    if match2:
                        ...
                        r = ""
                    addon_check = self.abbrev_addons(cat, game.clan.focus_cat, cluster, x, rel, r)

                    if game.clan.focus_cat.ID == cat.ID or game.clan.focus_cat.ID == game.clan.your_cat.ID or \
                    addon_check is False:
                        return ""

                    text = self.add_to_cat_dict("fc_c", cluster, x, rel, r, game.clan.focus_cat, text)
            else:
                if "fc_c" in text:
